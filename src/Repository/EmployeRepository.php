...
class EmployeRepository extends ServiceEntityRepository
{
    ...
    public function GetNombreEmailEnvoyer()
    {
        $q = $this->createQueryBuilder('e');
        $q->leftJoin('e.SendEmail', 'EmailEnvoyer', 'WITH')
            ->select('COUNT(EmailEnvoyer.id) as nbrEmailEnvoyer');
        return $q->getQuery()->getResult();
    }

    public function GetNombreReponseEnvoyer()
    {
        $q = $this->createQueryBuilder('e');
        $q->leftJoin('e.reponses', 'reponses', 'WITH')
            ->select('COUNT(reponses.id) as nbrReponseEnvoyer');
        return $q->getQuery()->getResult();
    }
}
